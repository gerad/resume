(function () {
  ...
  app.directive("skills", function () {
    return {
      scope: { skills: "=" },
      template:
        '<span class="skill" skill="{{skill}}" ng-repeat="skill in skills">{{skill}}</span>',
    };
  });
  ...
  function deserialize(json) {
    ...
    var skills = [];
    for (var skill in skillCounts) {
      skills.push(skill);
    }
    json.skills = skills.sort(function (a, b) {
